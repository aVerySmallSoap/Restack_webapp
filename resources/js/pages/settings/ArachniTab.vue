    ...
    <div class="p-4">
        <form @submit="onSubmit" class="mt-4">
            <div>
                ...
                <span class="pt-4 text-muted">Control how Arachni behaves</span>
                <Separator/>
            </div>
                        ...
                        <div class="space-y-0.5">
                            ...
                            <FormDescription class="flex">
                                <span class="self-center">
                                    Sets how long Arachni will scan (in seconds)
                                </span>
                            </FormDescription>
                        </div>
                        <FormControl>
            ...
            <div class="py-4">
                ...
                <span class="text-muted">Modules determine what payloads Arachni will execute</span>
                <Separator/>
            </div>
            <div class="pl-4">
                ...
                <FormField v-slot="{ value, handleChange }" name="cookieFlags">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription class="flex">
                                <span class="self-center">
                                    Allow Arachni to evaluate the security of cookies
                                </span>
                            </FormDescription>
                        </div>
                        <FormControl>
                ...
                <FormField v-slot="{ value, handleChange }" name="csp">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription class="flex">
                                <span class="self-center">
                                    Allow Arachni to evaluate the security level of Content Security Policies of the web server
                                </span>
                            </FormDescription>
                        </div>
                        <FormControl>
                ...
                <FormField v-slot="{ value, handleChange }" name="exec">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription class="flex">
                                <span class="self-center">
                                    Allow Arachni to detect scripts vulnerable to command and/or code execution
                                </span>
                            </FormDescription>
                        </div>
                        <FormControl>
                ...
                <FormField v-slot="{ value, handleChange }" name="file">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription class="flex">
                                <span class="self-center">
                                    Allow Arachni to detect file-related vulnerabilities such as directory traversal and include() vulnerabilities
                                </span>
                            </FormDescription>
                        </div>
                        <FormControl>
                ...
                <FormField v-slot="{ value, handleChange }" name="httpHeaders">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to evaluate the security of HTTP headers
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="permanentXss">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to detect stored (aka permanent) Cross-Site Scripting vulnerabilities on the web server
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="redirect">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to detect Open Redirect vulnerabilities
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="sql">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to detect SQL (also XPath) injection vulnerabilities using error-based or boolean-based (blind) techniques
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="ssl">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to evaluate the security of SSL/TLS certificate configuration
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="ssrf">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to detect Server-Side Request Forgery vulnerabilities
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="upload">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to detect unrestricted file upload vulnerabilities
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="xss">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to detect scripts vulnerable to XML external entity injection (also known as XXE)
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
                ...
                <FormField v-slot="{ value, handleChange }" name="exMode">
                    <FormItem class="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                Allow Arachni to execute expensive module #1
                            </FormDescription>
                        </div>
                        <FormControl>
                            <Switch
